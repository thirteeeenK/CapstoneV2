        ...
        <form action="{{ route('admin.packages.store') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200/80 shadow-xs space-y-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div class="sm:col-span-2">
                    ...
                    <textarea name="inclusions_text" rows="5" placeholder="3D2N Hotel Accommodation with daily breakfast&#10;Roundtrip Airport / Seaport Transfers&#10;Sunset Yacht Cruise with drinks&#10;Island Hopping Tour with Buffet Lunch" class="w-full px-4 py-3 rounded-xl border border-slate-200 text-xs font-medium text-slate-900 focus:border-sky-500 focus:ring-2 focus:ring-sky-500/20"></textarea>
                </div>
