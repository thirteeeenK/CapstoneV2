{{-- Live-search results partial: activities table only.
    The filter controls (destination/level tabs + search) live in the wrapper so the input never loses focus on AJAX swaps.
