{{-- Live-search results partial: listing table only.
    The filter controls (destination tabs + search) live in the wrapper so the input never loses focus on AJAX swaps.
