    ...
    public function run(): void
    {
        $vibes = [
            ...
            [
                'name' => 'Luxury & Spa',
                'icon' => 'spa',
                'description' => 'High-end pampering & resorts',
            ...
            [
                ...
                'icon' => 'local_bar',
                'description' => 'Vibrant music & island bars',
            ...
            [
                'name' => 'Nature & Eco',
                'icon' => 'forest',
                'description' => 'Pristine greenery & wildlife',
            ...
            [
                ...
                'description' => 'Peaceful retreat away from crowds',
            ...
            [
                ...
                'image_url' => 'https://images.unsplash.com/photo-1533587851505-d119e13fa0d7?auto=format&fit=crop&w=800&q=80',
                'sort_order' => 5,
                'is_active' => true,
            ],
            [
                ...
                'icon' => 'restaurant',
                'description' => 'Seafood feasts & local cuisine',
            ...
            [
                ...
                'description' => 'Safe pools & kid activities',
                'image_url' => 'https://images.unsplash.com/photo-1563299796-b729d0af54a5?auto=format&fit=crop&w=800&q=80',
                'sort_order' => 7,
                'is_active' => true,
            ],
        ];
        ...
        $travelerTypes = [
            ...
            [
                ...
                'icon' => 'favorite',
                'description' => 'Romantic & private',
                'image_url' => 'https://images.unsplash.com/photo-1519744792095-2f2205e87b6f?auto=format&fit=crop&w=800&q=80',
                'sort_order' => 1,
                'is_active' => true,
            ],
            [
                ...
                'icon' => 'family_restroom',
                'description' => 'Spacious & kid friendly',
            ...
            [
                'name' => 'Friends Group',
                'icon' => 'groups',
                'description' => 'Group suites & activities',
        ...
        $activities = [
            [
                'name' => 'Sightseeing',
                'icon' => 'explore',
                'description' => 'Vans, e-trikes & viewpoints',
                'image_url' => 'https://images.unsplash.com/photo-1534447677768-be436bb09401?auto=format&fit=crop&w=800&q=80',
                'sort_order' => 0,
                'is_active' => true,
            ],
            [
                'name' => 'Underwater',
                'icon' => 'scuba_diving',
                'description' => 'Scuba, helmet diving & coral reefs',
                'image_url' => 'https://images.unsplash.com/photo-1544551763-46a013bb70d5?auto=format&fit=crop&w=800&q=80',
                'sort_order' => 1,
                'is_active' => true,
            ],
            [
                'name' => 'Relaxing',
                'icon' => 'self_improvement',
                'description' => 'Island hopping, sailing & kayak',
                'image_url' => 'https://images.unsplash.com/photo-1506929562872-bb421503ef21?auto=format&fit=crop&w=800&q=80',
                'sort_order' => 2,
                'is_active' => true,
            ],
            [
                'name' => 'Adventure',
                'icon' => 'hiking',
                'description' => 'ATV, zipline & banana boat',
                'image_url' => 'https://images.unsplash.com/photo-1533587851505-d119e13fa0d7?auto=format&fit=crop&w=800&q=80',
                'sort_order' => 3,
                'is_active' => true,
            ],
            [
                'name' => 'Extreme',
                'icon' => 'paragliding',
                'description' => 'Parasailing & jet ski thrills',
                'image_url' => 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=800&q=80',
                'sort_order' => 5,
                'is_active' => true,
            ],
