...
class RoomSeeder extends Seeder
{
    ...
    {
        $henannPalmBeachResort = HotelModel::where('hotel_name', 'Henann Palm Beach Resort')->first();
        $canyonHotelsResortsBoracay = HotelModel::where('hotel_name', 'Canyon Hotels & Resorts Boracay')->first();
        $boracayOceanClubBeachResort = HotelModel::where('hotel_name', 'Boracay Ocean Club Beach Resort')->first();
        $henannGardenResort = HotelModel::where('hotel_name', 'Henann Garden Resort')->first();
        $myStationHotel = HotelModel::where('hotel_name', 'My Station Hotel')->first();
        $frendzResortHostel = HotelModel::where('hotel_name', 'Frendz Resort & Hostel')->first();
        $lazyDogBedBreakfast = HotelModel::where('hotel_name', 'Lazy Dog Bed & Breakfast')->first();
        $happinessHostel = HotelModel::where('hotel_name', 'Happiness Hostel')->first();
        $theMuseHotel = HotelModel::where('hotel_name', 'The Muse Hotel')->first();

        $rooms = [
            [
                'hotel_id' => $henannPalmBeachResort?->id,
                ...
                'base_price' => 9500.00000000,
                'images' => [
                    'hotels/hennan-palm-beach-resort/hen-bed.jpg',
                ],
                'is_shown' => true,
            ],
            ...
            [
                ...
                'base_occupancy' => 2,
                'max_occupancy' => 3,
                'extra_person_fee' => 1100.00000000,
                ...
                'base_price' => 11200.00000000,
                'images' => [
                    'hotels/hennan-palm-beach-resort/henann.jpg',
                    'hotels/hennan-palm-beach-resort/hennan-palm.jpg',
                ],
                'is_shown' => true,
            ],

            [
                'hotel_id' => $canyonHotelsResortsBoracay?->id,
                ...
                'ideal_guest' => 'Couples, Small Families',
                'additional_notes' => null,
                'total_rooms' => 2,
                'occupancy' => 2,
                'base_occupancy' => 2,
                ...
                'base_price' => 5200.00000000,
                'images' => [
                    'hotels/canyon-hotel/bed-canyon.jpg',
                    'hotels/canyon-hotel/bed.jpg',
                    'hotels/canyon-hotel/double.jpg',
                ],
                'is_shown' => true,
            ],

            [
                'hotel_id' => $boracayOceanClubBeachResort?->id,
                ...
                'base_price' => 6800.00000000,
                'images' => [
                    'hotels/Boracay-Ocean-Club-Beach-Resort/ocean.webp',
                    'hotels/Boracay-Ocean-Club-Beach-Resort/ocean_balcony.jpg',
                    'hotels/Boracay-Ocean-Club-Beach-Resort/ocean_club.jpg',
                ],
                'is_shown' => true,
            ],

            [
                'hotel_id' => $henannGardenResort?->id,
                ...
                'base_price' => 8400.00000000,
                'images' => [
                    'hotels/Henann-Garden-Resort/hen-garden-bed.jpg',
                    'hotels/Henann-Garden-Resort/hennan-bed.jpg',
                    'hotels/Henann-Garden-Resort/hennan-garden-pool.jpg',
                ],
                'is_shown' => true,
            ],

            [
                'hotel_id' => $myStationHotel?->id,
                ...
                'base_price' => 2200.00000000,
                'images' => [
                    'hotels/My-Station-Hotel/station-bed.jpg',
                    'hotels/My-Station-Hotel/station-camp.jpg',
                    'hotels/My-Station-Hotel/station-double.jpg',
                ],
                'is_shown' => true,
            ],

            [
                'hotel_id' => $frendzResortHostel?->id,
                ...
                'ideal_guest' => 'Solo Backpackers, Social Youth Travelers',
                'additional_notes' => null,
                'total_rooms' => 2,
                'occupancy' => 1,
                'base_occupancy' => 1,
                ...
                'base_price' => 850.00000000,
                'images' => [
                    'hotels/Frendz-Hostel-Boracay/frendz-bed.jpg',
                    'hotels/Frendz-Hostel-Boracay/frendz-double-bed.jpg',
                    'hotels/Frendz-Hostel-Boracay/frendzzz.jpg',
                ],
                'is_shown' => true,
            ],

            [
                'hotel_id' => $lazyDogBedBreakfast?->id,
                ...
                'base_price' => 2800.00000000,
                'images' => [
                    'hotels/Lazy-Dog/lazy-bed.jpg',
                    'hotels/Lazy-Dog/lazy-room.jpg',
                    'hotels/Lazy-Dog/lazy.jpg',
                ],
                'is_shown' => true,
            ],

            [
                'hotel_id' => $happinessHostel?->id,
                ...
                'ideal_guest' => 'Digital Nomads, Couples, Wellness Seekers',
                'additional_notes' => null,
                'total_rooms' => 2,
                'occupancy' => 2,
                'base_occupancy' => 2,
                ...
                'base_price' => 3200.00000000,
                'images' => [
                    'hotels/happiness-hotel/happy.jpg',
                    'hotels/happiness-hotel/happinesss.jpg',
                ],
                'is_shown' => true,
            ],

            [
                'hotel_id' => $theMuseHotel?->id,
                ...
                'ideal_guest' => 'Chic Couples, Premium Travelers',
                'additional_notes' => null,
                'total_rooms' => 2,
                'occupancy' => 3,
                'base_occupancy' => 2,
                'max_occupancy' => 3,
                'extra_person_fee' => 600.00000000,
                'bed_configuration' => '1 King Bed',
                'room_size' => '36 sq.m',
                'room_amenities' => [
                    'Balcony',
                ...
                'base_price' => 4900.00000000,
                'images' => [
                    'hotels/muse-hotel/muse-bed.webp',
                    'hotels/muse-hotel/muse-pool.webp',
                    'hotels/muse-hotel/muse-viewdeck.webp',
                ],
                'is_shown' => true,
            ],
        ];
