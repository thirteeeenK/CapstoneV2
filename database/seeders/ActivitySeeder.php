    ...
    public function run(GeminiService $geminiService): void
    {
        ...
        $activities = [
            [
                ...
                'inclusions' => ['Boat transfer', 'Buffet Lunch', 'Kawa Bath', 'Tour Guide'],
                'exclusions' => ['Snorkeling Fee (₱40)', 'Crystal Cove Entrance (₱300)', 'Magic Island Cliff Diving (₱250)'],
                'itinerary' => [
                    ['title' => 'Meetup at Station 2', 'duration' => '30 mins'],
                    ['title' => 'Puka Beach', 'duration' => '1 hour'],
                    ['title' => 'Crocodile Island Snorkeling', 'duration' => '1 hour'],
                    ['title' => 'Buffet Lunch & Kawa Bath', 'duration' => '1.5 hours'],
                    ['title' => 'Magic Island (Optional)', 'duration' => '1 hour'],
                ],
            ...
            [
                ...
                'requirements' => 'Wear comfortable clothes and walking shoes.',
                ...
                'inclusions' => ['E-Trike rental with driver', 'Hotel pick-up/drop-off'],
                'exclusions' => ['Mt. Luho Entrance Fee', 'Food and Drinks'],
                'itinerary' => [
                    ['title' => 'Pick up', 'duration' => '15 mins'],
                    ['title' => 'Boracay Keyhole', 'duration' => '30 mins'],
                    ['title' => 'Newcoast Beach', 'duration' => '45 mins'],
                    ['title' => 'Puka Beach', 'duration' => '1 hour'],
                    ['title' => 'Mt. Luho Viewpoint', 'duration' => '30 mins'],
                ],
